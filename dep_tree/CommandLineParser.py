...
class CommandLineParser(object):
  ...
  def __init__(self):
    ...
    parser.add_argument( "product" , metavar = "product" , help = "output product: xtclsh (xtclsh script); vivado (vivado script); sim (Modelsim script); components (component list}; addrtab (address table list); b (address decoder script); files (flat file list)")
