...
def project(env, output):
    ...
    lLibSearchPaths = [lModelsimIni.get('vsim', 'librarysearchpath')] if  lModelsimIni.has_option('vsim', 'librarysearchpath') else []
    lLibSearchPaths += lSimLibs

    lModelsimIni.set('vsim', 'librarysearchpath', ' '.join(lLibSearchPaths))
